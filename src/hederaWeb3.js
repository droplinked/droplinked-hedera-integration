...
import {contractAddress} from './hederaConstants'
import { hethers } from '@hashgraph/hethers';
import { NetworkName } from '@hashgraph/sdk';
const provider = new ethers.JsonRpcProvider("https://apiv2.droplinked.com/http-req?method=post&url=https://testnet.hashio.io/api");
...
export async function getTransactionEvents(txHash){
